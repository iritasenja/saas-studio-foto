// npx supabase gen types typescript --project-id "zslpubyszimzkhbwicfk" | Out-File -Encoding utf8 app/types/database.types.ts
  ...
  public: {
    Tables: {
      ...
      booking_number_sequences: {
        ...
        Relationships: [
          {
            foreignKeyName: "booking_number_sequences_tenant_id_fkey";
            columns: ["tenant_id"];
            isOneToOne: false;
            referencedRelation: "tenants";
            referencedColumns: ["id"];
