    ...
    Tables: {
      ...
      studio_business_hours: {
        Row: {
          ...
          created_at: string;
          day_of_week: number;
          end_breaktime: string | null;
          id: string;
          is_day_off: boolean;
          open_time: string | null;
          start_breaktime: string | null;
          tenant_id: string;
          updated_at: string;
        };
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "studio_business_hours_tenant_id_fkey";
            columns: ["tenant_id"];
            isOneToOne: false;
            referencedRelation: "tenants";
            referencedColumns: ["id"];
      ...
      studio_day_off_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "studio_day_off_events_tenant_id_fkey";
            columns: ["tenant_id"];
            isOneToOne: false;
            referencedRelation: "tenants";
            referencedColumns: ["id"];
